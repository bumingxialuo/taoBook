...
@interface EnglishBookVC ()<UITableViewDelegate,UITableViewDataSource>

@end

@implementation EnglishBookVC
...
//    cell.textLabel.text = @"测试-英语-测试";
    return cell;
}

#pragma mark- scrollViewDelegate
- (void)scrollViewDidScroll:(UIScrollView *)scrollView{
    if ([self.delegate respondsToSelector:@selector(EnglishBookVCDidScroll:)]) {
        [self.delegate EnglishBookVCDidScroll:scrollView.contentOffset.y];
    }
}
